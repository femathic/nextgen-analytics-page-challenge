...
const Navs = () => (
  <section className="flex flex-col md:flex-row flex-wrap items-center justify-around lg:justify-between nav-background-color py-4 px-6 xl:pl-24 lg:pr-36 xl:pr-64 shadow wow fadeInDown">
    ...
    <div className="flex flex-col items-center text-sm mx-8 my-4 tracking-wider">
    ...
    <div className="flex flex-col items-center text-sm mx-8 my-4 lg:mr-16 tracking-wider">
